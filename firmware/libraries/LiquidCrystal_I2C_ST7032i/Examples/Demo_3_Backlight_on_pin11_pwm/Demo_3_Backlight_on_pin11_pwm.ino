...
This demo assumes the backlight is connected via an appropriate series resistor to Arduino pin 11.
Arduino pin 11 is PWM capable so backlight control includes dimming the backlight in addition of switching it on/off.
*/
...
LiquidCrystal_I2C_ST7032i lcd(0x3E,8,2,11);  // set the LCD address to 0x3E for a 8 chars and 2 line display using pin 11 for backlight control
