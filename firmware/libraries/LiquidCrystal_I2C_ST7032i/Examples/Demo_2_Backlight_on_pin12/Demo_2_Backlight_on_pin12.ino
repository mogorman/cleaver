...
This demo assumes the backlight is connected via an appropriate series resistor to Arduino pin 12.
Arduino pin 12 is not PWM capable so backlight control is limmited to switching it on/off.
*/
...
LiquidCrystal_I2C_ST7032i lcd(0x3E,8,2,12);  // set the LCD address to 0x3E for a 8 chars and 2 line display using pin 12 for backlight control
